...
module DataMemory(Address, WriteData, Clk, MemWrite, MemRead, ReadData, Size); 
    ...
    if(MemRead == 1) begin
            ...
            ReadData <= { { 16 { memory[Address[16:2]][15] } }, memory[Address[16:2]][15:0] };
            else if (Size == 2'b10)
            ReadData <= { { 24 { memory[Address[16:2]][7] } }, memory[Address[16:2]][7:0] };
            end
      else begin
     ReadData <=  0;
     end
